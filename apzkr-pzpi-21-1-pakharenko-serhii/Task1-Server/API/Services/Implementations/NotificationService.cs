...
public class NotificationService(GuardicDbContext context) : INotificationService
{
    public async Task<Result<NotificationDto>> ReadNotificationById(int notificationId)
    {
        ...
        return Result.Ok(new NotificationDto(notification.Message, notification.isRead, notification.GuardId));
    }
    ...
    public async Task<Result<List<NotificationDto>>> GetAllNotifications()
    {
        ...
        return Result.Ok(notifications.Select(n => new NotificationDto(n.Message, n.isRead, n.GuardId)).ToList());
    }
